...
| `drafting-assistant` | 1.7.1 | inherit | Approved outline → first-draft prose in the author's voice |
...
| `romance-reader-panel` | 1.6.3 | inherit / high | Simulated 35–45 romance reader: engagement, skim, swoon, DNF |
