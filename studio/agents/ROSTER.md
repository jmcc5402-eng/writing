...
| `drafting-assistant` | 1.7.2 | inherit | Approved outline → first-draft prose in the author's voice |
...
| `continuity-keeper` | 1.4.4 | inherit | Facts vs canon + scene staging; classifies contradiction / unestablished / deliberate |
...
| `romance-reader-panel` | 1.6.4 | inherit / high | Simulated 35–45 romance reader: engagement, skim, swoon, DNF |
