...
| `author-proxy` | 1.1.1 | inherit / high | Reads a draft AS THE AUTHOR — the six standing questions (studio/AUTHOR-QUESTIONS.md) and the author's comments verbatim as its only brief; writes the comments the author would, before the panel; scored against the real comments after |
