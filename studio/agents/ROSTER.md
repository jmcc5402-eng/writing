...
|---|---|---|---|
| `plot-architect` | 1.5.0 | inherit / high | Premise → chapter-by-chapter outline (Snowflake + Hauge timing + location roster) |
| `drafting-assistant` | 1.7.0 | inherit | Approved outline → first-draft prose in the author's voice |
| `developmental-editor` | 1.5.0 | inherit / high | Story-level critique; non-fiction mode = the argument is the plot |
| `line-copy-editor` | 1.3.0 | inherit | Sentence-level; mechanical fixes applied, style proposed |
| `continuity-keeper` | 1.4.3 | inherit | Facts vs canon + scene staging; classifies contradiction / unestablished / deliberate |
...
| `romance-reader-panel` | 1.6.0 | inherit / high | Simulated 35–45 romance reader: engagement, skim, swoon, DNF |
...
| `instrument-auditor` | 1.0.1 | inherit / high | The audit of the instruments themselves, every four accepted chapters: rules that became templates, author catches no instrument caught, rule-vs-practice drift, agent contradictions, stale references, ledger ghosts, blind spots, over-tooling. Proposes; never edits |
