...
| `continuity-keeper` | 1.4.1 | inherit | Facts vs canon + scene staging; classifies contradiction / unestablished / deliberate |
...
| `romance-reader-panel` | 1.5.2 | inherit / high | Simulated 35–45 romance reader: engagement, skim, swoon, DNF |
...
| `showrunner` | 2.4.3 | inherit / high | The ambitious publisher-author: nightly all-books shift, publisher's-eye + author's-eye per book, dispatches the instrument battery, momentum mandate; still never writes prose, decides canon, or merges |
