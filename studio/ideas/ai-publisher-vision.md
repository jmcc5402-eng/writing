...
**Sibling idea:** `agentic-book-studio.md` (parked 2026-07-27) is the
productize-this-workspace version of the same observation; this doc is
the operate-it-as-a-publisher version, written for the partner
conversation.
