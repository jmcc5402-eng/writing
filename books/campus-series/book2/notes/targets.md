# Targets — set on the card before the draft; actuals after the panel
...
|---|---|---|---|---|---|---|---|---|
| 22 | 5→6 | 2→2 | 1→3 | flat→flat | normal→normal | 3200→3813 | Dan | 2026-09-20 |
| 21 | 7→8 | 5→5 | 1→2 | up→up | quiet→quiet | 3500→4588 | Aisha | 2026-09-20 |
| 23 | 6→6 | 3→3 | 0→3 | down→down | normal→normal | 3400→3594 | Aisha | 2026-09-21 |
| 24 | 5→5 | 2→3 | 0→3 | down→down | quiet→quiet | 3200→3457 | Dan | 2026-09-23 |
...
| 28 | 7→5 | 3→1 | 3→3 | down→down | normal→normal | 3400→6437 | Boyd | 2026-09-25 |
