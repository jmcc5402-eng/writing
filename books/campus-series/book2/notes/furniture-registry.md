...
| The second stool | the second stool from the register at the Checkerboard, next to Coach's (the stool nearest the register); hers on weekday mornings (ch 5, 9); **thirty-four's from Dec 22 till the semester starts, breakfasts on her card with the cook** ("It's eggs."); Dan is never told | ch 5, 9, 17 |
