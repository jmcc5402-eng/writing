...
→ lint → ONE PR with the card on top of the listening file.

**THIS BRIEF TRIALS THE FLOOR** (second instrument audit, F18): for
every scene the leads share, a word floor and the instruction that
it runs long. The four ceiling slots (THE OTHER LEAD'S FACE, THE
SLOW BEAT, THE ENDING THINKS, THE LAST EXCHANGE) are folded into
THE LEADS' SCENES below; no touch in this brief is "one line."

**Outline entry, verbatim manifest** (`plots/b12-outline.md:599–614`):
"The exodus; the town at parking-space size; Christmas loud for the
married and long for the rest (estate 6 assigned: 'she had stopped
expecting it years before she stopped wanting it'). Verna's motel
empties and the two of them get the one lit room — HEAT 2, standard
9, the cut executed on the ch 23-A model. Cal × Marisol
settled-couple cameo at the Checkerboard (estate 58–59 register),
the carryover reader's warm scene. The Gaults drive to Birmingham
with a folder of hopes aimed against her (B2-T04 on the page;
contents dark). The meal train for the Gaults gets a plate from
Earlene anyway (the grain-rule joke, spent once). — Plants: F2's
...
the author has asked for room three times). Epigraph on top (≤35
words, texture, out-of-state register — the board over Christmas:
parents home, the album gone quiet; no plot beat). Write
`manuscript/ch17.md` new; header per ch 15's form.

---

## THE ROMANCE MOVE (first line)

**The one lit room: the first night with the whole night in front
of them, and the page gives it the room the author asked for.** In
4 / Out 4 (stage 4, seen: Verna half-sees; the town does not know).
HEAT 2 — the second heat scene, STANDARDS 9: everything up to the
first piece of clothing on the floor is on the page and the scene
cuts there. The ladder plays at its ceiling (8) with a NEW sense
for the approach in her POV (the audit lists what is spent). The
firewall holds without being touched: nothing about the call, the
Gaults, Birmingham, the chart, the letter is said in the room. Ends
...
The chapter has two scenes the leads share: the Checkerboard
...
to go); the approach to every touch on the page — the distance, the
eyes, the hand moving, the pause — at least six sentences before the
first contact and more before the first garment; no run of short
volleys anywhere; the last exchange full sentences; and the scene's
end THINKS — what she thinks about him and about the thing she is
afraid of, in plain sentences, before the cut. The sentences run
out. Semantic line breaks are not a license to clip.

**WOVEN:** he is in every scene of hers — the empty clinic (his
building dark across the lot; the poles off; the terms); the
Checkerboard (his stool by the register empty, or him on it, and the
town's eyes; the settled couple as the thing they are not allowed
to be yet); the Gaults' release (his "review" in the same week; what
the report will mean for both of them); Christmas Day (the clinic
line; what she does not have and does); the lit room (present).
...
to the first Wednesday in February — never "the eleventh"); what it
costs (the report on its way to Birmingham; his review). NO
calendar-first line; `opening-check.py` runs on the first paragraph
and the audit reads every section's first paragraph for the seams
(the 5:15 check and "at her desk at the warm end" are spent shapes
— F23).

## THE ARGUMENT, SAID

The town that packed itself into one Saturday has gone home, and the
two people it blamed are the two people left in it. She has a rule
that keeps her work out of any room with a door, and this week the
rule gets its first real test: a room with a door, a whole night,
and nothing to say about the call. She keeps it, and it costs her
nothing yet. Meanwhile the family she held out of a game drives to
another city to prove her wrong, with her own chart in the car,
because she sent it.
...
1. **The empty town, MONDAY the twenty-first** (short; the
   ...
   (town-ashford §7 Winter; the audit rules the day and whether
   crews work the week of Christmas); the motel's VACANCY word lit;
   the clinic's holiday line forwarded to her cell (dossier row 17
   NEW), the first call on it. **ROOTING FOR, BEFORE THE FIRST
   ROMANCE BEAT:** thirty-four comes through the empty clinic with
   something small and not the hamstring (`[TK roster: thirty-four
...
2. **The Checkerboard, a weekday morning** (short-middle; public;
   the settled couple). One cook; Earlene walking the pot; Cal
   Sutter and Marisol Pruett at the counter, the couple from Book
   One at ease — the carryover reader's warm scene (estate 58–59
   register: the audit pulls the register from Book One's pages);
   thirty-four on the second stool, or the stool empty with his
...
4. **Christmas Day** (short; alone; one paragraph or two). The
   never-married Christmas in her words, plain (estate 6, once: she
   had stopped expecting it years before she stopped wanting it —
   the audit confirms the line is unspent); the holiday line rings
   once and she takes it; what she does with the day (the audit
   rules what a doctor alone in a motel does on Christmas — a run,
   the chart, a call to `[TK family — OPEN; do not resolve]`, none of
...
5. **The one lit room** (THE SCENE — the floor above). The motel
   ...
   awkward beats; nothing about the call (one start-and-stop at
   most, hers or his); then the approach, slow, on the page —
   distance, eyes, hands, pauses, a NEW sense (the audit lists the
...
1. The empty town — kind 4 (his building dark across the lot; the
   terms) + kind 8 (what she wants from the week and will not say).
2. The Checkerboard — kind 6 (Marisol's eyes; Earlene's plate for
   the doctor "anyway") + kind 5 ("Doc." / "Coach." with a settled
   couple watching) + kind 7 (the couple they are not allowed to be).
3. The release — kind 4 (his review in the same week; the report's
   meaning for both).
4. Christmas — kind 4 (him as a person, warm; the one good thing).
5. The lit room — kind 1 (the approach; the new sense), kind 2 (his
   face, new fact), kind 3 (want, plain), kind 5, kind 8 (what she
   thinks before the cut).

## REVERSAL — who loses what

The town loses its size. The Gaults lose the argument in Birmingham
and do not say so (F2 begins: Missy's posts go quiet). Aisha loses
her one seat at the Checkerboard on purpose, and her rule gets a
night with a door and holds. Dan loses nothing on the page and is
one lit window from losing everything, and walks down anyway.
...
## THE STAKES, THIS CHAPTER (replaces STAKES RESTATED — F23)

What this chapter puts at risk, in her terms: the Birmingham report
(her call, tested by another doctor, with her own chart as the
evidence); the terms (a lit room in an empty motel with the one
woman in town who counts doors); and the firewall's first night
with a door.

## COUPLE LINE

They share the Checkerboard (public, a counter, nothing to see) and
the lit room (the whole night). HEAT 2 at the ceiling; a new sense
in her POV; the cut at the first garment; the firewall untouched.

## END REGISTER: UP. Ch 16 ended DOWN.

## ROOTING FOR (taste 15; the beer test — who saw it, who thanked it)

Aisha: the stool for thirty-four (before the first romance beat;
Earlene sees, later, and never says; nobody thanks); the chart to
Birmingham unasked (Missy sees; does not thank). Dan (seen): NONE for
a third party this chapter, by design (his POV is 18 — the walk-on's
film); the card says so.

## NAMING, FULL LIST

Narration (her POV): "Dan" / "Dan Merritt" once; "Merritt" only as
the doctor at him. Aloud, in public: "Coach"; in the room: "Dan"
(spent; may be used, inside sentences). He: "Doc" in public;
...
`[TK — none named; "Birmingham" / "the doctor in Birmingham"]`.
...
- Calendar words: the date once; "Christmas" allowed; "the
  ...
  weeks" once.
- BANNED (RECENT.md as of 2026-09-10 — read it — plus): the calendar
  opening; "name in my mouth"; the half smile; "not a verdict";
  "there and gone"; "a foot of air"; "It had never been far."; "on
  purpose" standalone; the palm on the door; "the whole of"; "and
  that was the first time"; the "Doc."/"Coach." close; "quiet in the
  good/bad way"; "I'm keeping it"; "no way" as his; "conversational";
  "walk home together"; "the county had an answer"; "Till the poles
  went off"; "dark from her door to his"; "at her desk at the warm
  end of the annex" as an establishing line (spent ×2); "Aisha was
  at her desk" as a section's first words; "a foot" / "an arm" as a
  measured gap; "plainly" more than once; "something in her/his
  [face/chest/mouth]" more than once; "the way X did Y";
  "somebody's"; "never once"; "one beat"; "supper"; "casserole"; any
  sentence quoted as an example in the audit addendum (the addendum
  bans its own examples — keeper 1.4.1); heat in a vehicle; a coffee
  at night; "the size of him in a small room" (spent ×2).
- ECHO REPLIES: a short reply that only repeats the line before it
  is a finding anywhere (`ending-check.py`).
- QUOTAS: ONE two-dash sentence; two "which" appendixes; no scene
  change by bell; "a while" once; three personifications; one
  involuntary-body beat; "since June" once.
- BEVERAGE: coffee mornings only (the Checkerboard); seltzer or
  nothing at night; a can in room nine is hers; no bottle.
- FURNITURE: the square and its parking; the Checkerboard (one cook;
  the stool nearest the register — Dan's; the second stool — hers;
  the Coach's Slice; Earlene walks the pot); the Mule's dark TV
  (from outside); Millrow's curbs chalked; the Magnolia Court (the
  office window, the VACANCY word lit, room nine, the furnace note,
  the blanket, the RAV4 nosed out — but this is not a game day); the
  annex (the emptied records room; her office; the warm-end door;
  the clinic); the Fieldhouse dark or one window; the parka with the
