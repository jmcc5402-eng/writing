# Brief — Chapter 26: "The Survey Stakes" (Dan · Monday the 25th, a step back; then Thursday, January 28 — the interview, the silence, the standoff, the turn signal)

**Status: SET PIECE — three blind drafters (distinct variance cards,
same brief and addendum).** The showrunner adds it on judgment (the
conveyor, item 5): the book's dark night (BEATS, "Dark night | 82 |
26"), the interview the author ruled (B2-D31.10), the heat notch at
her door, and the setup for both climaxes (B2-D33). Romance-arc row 26,
In 5 / Out 5: "The standoff: each offers the other the exit." Arc-docs
26 (Dan): "Offers her the exit… Neither accepts. The turn signal away
from home. — The decision made, not yet spent." The card
(`notes/cards/ch26-card.md`) and this brief are audited TOGETHER by
...
lets it cost). Fun 0. Town 1: Odell's shop, one voice on her side.
Menace 2: the athletic director's July line — the partner comes either
way — Boyd's reason with Boyd's name nowhere on it (B2-D31.2). Talk
NORMAL (15–25%). Ends BUTTON (dark) on the turn signal. Pays Dan.
Words 3000; 3450 the ceiling (±15%).

## MAIN MOVED — the rulings this chapter carries (read first; overrides the body)

1. **The interview — Dan's one big mistake, shown (B2-D31.10, A).**
   The chapter OPENS a step back, Monday the twenty-fifth, in the room
   where the independent review interviews him. `[TK who conducts the
   review; the room's building]` The university's lawyer is beside him
   (ch 24's lawyer; unnamed). His head is on HER the whole time, on the
   page — the car window (ch 24), her face through the glass, the
   parka's twin on his hook (ch 18) — and that is why he is off his
   game (the author: "internal monologue where he's thinking about her
   and struggling and that's why he was off his game"). The reviewer
   asks whether, knowing what he knows now, he would have played Trey
   on the nineteenth. He misses the trap. He answers as the coach he
   used to be: **"Every coach in the country plays him. I'd have played
   him."** The half he means — that is exactly why it is not his call —
   stays in his head, and the page lets the reader FEEL it unfinished
   without writing it (BANNED: the half itself, any wording; ch 27 says
   it). The reader learns here what Aisha does not know: an honest slip
   by a man thinking about her. Angry at 25, understood at 26.
2. **The athletic director's two things (B2-D31.2, D31.7).** Thursday
   morning, the athletic director's office. (a) Once, in his own words:
...
3. **The dream job, and the staff (D31.5).** The struggle on the page,
   ...
   his staff's jobs ride on his extension (new canon, D31.5 — said once,
   plain); and her. He chooses silence through the hearing week on the
   lawyer's advice, and knows what it costs her.
4. **The chance to correct it, refused (D31.10; D31.3).** Thursday
   evening, the Coach's Table (Delmar's screen porch, WDSS 1340, one
   hour — registry 41). Tick gives him the air — the same air where he
   said "her protocol" on the fourteenth — and he lets the sound bite
...
5. **Whit — the trainer is a person (B2-D32).** Named on the page:
   ...
   winter-workout kid) and says his girl is a sophomore here. The
   gambling VERY LIGHT (the author: "does not need to be a big
...
8. **The standoff at her door (arc-docs 26; the card's calls, RULED at
   ...
   in it: two true accountings that don't sum. **Call 1 (default):** he
   starts to explain the sound bite and SHE STOPS HIM — the meaning
...
9. **The turn signal (arc-docs 26; B2-D33.1).** In the truck after:
   ...
   on it. Then the turn signal AWAY from home, and nothing said about
   where he is going. The reader must be able to read it as a choice at
   27. ENDS BUTTON, dark, on the signal.
10. **Heat — the new line (HANDOFF H009; STANDARDS 9 as ruled
...
11. **The stake said plain ONCE (#185; F-DAN-02).** Caught in a
    ...
    once, from Dan's side; every other stake a hint.
12. **The body, not the talk (H007).** Talk is NORMAL here (15–25%),
    so the body has to carry more: chapter-lint TALK vs BODY under 2.0.
    The interview and the door are where his body runs.
13. **The ending (B2-D33).** Everything here sets up the two climaxes:
    the unfinished sentence (27), the cost he weighs (27), the loaded
    car (29), "he has not asked" (29 — he does NOT ask her to stay
    here; he offers to take the cost, which is not asking). BANNED:
    Dan asking her to stay, in any wording — that is the book's climax,
    ch 29's.
...
MECHANICAL (commands, output attached at the end)
  [ ] bash studio/tools/chapter-lint.sh manuscript/ch26.md → BANS clean; TOUCH SPAN ≥4 body sentences at the highest touch (the kiss); no crowding; ≤2 questions ending in a period
  [ ] python3 studio/tools/dialogue-lint.py manuscript/ch26.md → normal band (15–25%)
  [ ] python3 studio/tools/bans.py manuscript/ch26.md → clean
  [ ] python3 studio/tools/opening-check.py / ending-check.py → not a repeat (NOT a plate or a counter — 25; NOT an email at a door — 24; NOT a car loaded or a storm door as the ending — 25)
  [ ] python3 studio/tools/fact-check.py books/campus-series → clean
  [ ] sentences ordinarily under 30 words, ≤3 "and"s; wrap at 80; ≤3450 words — AND a tail: SENTENCE SHAPE CV ≥ 0.60, p95 ≥ 33, at least one sentence over thirty (H001; L071)
  [ ] chapter-lint TALK vs BODY under 2.0 (H007)
READERS (verdict files, path attached at the end)
  [ ] author-proxy 1.1.1    → notes/ch26-author-proxy-<A|B|C>-<date>.md (BEFORE the panel)
  [ ] romance-reader-panel  → notes/ch26-panel-<A|B|C>-<date>.md (BLIND — on the card-blind copy)
  [ ] continuity-keeper     → notes/ch26-keeper-<date>.md
  [ ] /chapter-score        → notes/scores/ch26-score.md
...
Stage 5 held, In 5 / Out 5 (romance-arc row 26: "The standoff: each
offers the other the exit"). The chapter's move on the feeling: the
reader, angry at him since 25, learns he is guilty of a slip and not a
betrayal — and then watches him choose to let it stand, which is worse
...
ONE scene together: the standoff at her door at the Magnolia Court,
night — the longest scene in the chapter, the chapter's highest
moment; slow down (taste 16). He is on her the rest of the chapter:
the interview (his head on her), the athletic director's office (she
is leaving — his body at it), the air (her protocol replayed), the
truck. APART, WHY — said once, plain, in his head: the lawyer's
advice; anything he says makes it worse for her (ch 24); the stake.

## THE OPENING, SAID

Monday the twenty-fifth, a step back — the page SAYS it is Monday and
that the chapter will come forward to Thursday (the reader has just
come from Aisha's Tuesday; no confusion — taste 1). MID-MOTION on a
thing that is none of the accepted openings (… 23 the thumb through the
album, 24 the rain on the windshield, 25 the plate coming down): e.g.
the lawyer's hand turning a legal pad square, a water pitcher, the
reviewer's pen — the drafter's pick, not these. The date inside a
sentence that does something else — NOT the weekday-and-date line as
its own sentence (the sixth chapter running, keeper N12 i).

## THE ARGUMENT, SAID

*The county heard him say he'd have played the boy. The man who said
it was thinking about the doctor and missed the trap. The school's
lawyer says silence protects her; silence is also what is costing her.
She is leaving, and he hears it from his boss.* Between the leads:
*each would rather be the one who pays; the one thing that would fix
it — say the rest of the sentence where it counts — is the one thing
that costs him the job, and she will not let him say it to her
instead.*

## THE SCENES

1. **Monday the twenty-fifth — the interview room** (the opening; a
   step back). The review's room `[TK]`; the reviewer `[TK]`; the
   lawyer beside him. His head on her across the beats (the window,
...
| 6. Night, the door | Romance felt 8: the standoff, the kiss, her ending it | Aisha: angry, wanting, packed; Verna: one look; Dan: offers the cost | Why he is there (the car, the athletic director's news); why she stops the explanation | Nobody says "I love you"; the kiss and the refusals do it | The point: each would rather pay; neither accepts. Stakes blatant: the stake said once here or scene 2 | The gravel, the cold, the door, her body against his | — |
| 7. The truck | Romance felt 6: the cost weighed; the signal | Dan: TURNED | Nothing said about where; the reader infers at 27 | Nobody says "he's going to testify" | The point: the decision made, not yet spent | The ticking signal, the dash, the road | — |

## ROMANCE BEATS (one per scene, at least three, two kinds)

Scene 1 — kinds 8, 9 (her in his head; his body at the question).
Scene 2 — kind 4 (the news in his body). Scene 3 — kind 6. Scene 4 —
kind 6. Scene 5 — kind 8. Scene 6 — kinds 1, 2, 5, 8 (the kiss; the
refusals; the want said). Scene 7 — kind 8. The proxy and the panel
on the author's anchors; seven tokens on the proxy's line.

## REVERSAL — who loses what

Dan loses her (she is going, and he hears it second-hand), the
county's benefit of the doubt (he lets it stand on the air), and — in
the truck — decides to lose the extension (PAYS Dan). Aisha loses the
explanation she will not take from him privately. Whit becomes a
person. Boyd gains a staked lawn and is never named.

## ARC BEATS

**Dan (arc-docs 26; dossier row 26):** offers her the exit; neither
accepts; the turn signal — the decision made, not yet spent. (The
dossier's reference call for fifty-six is CUT — the card's call 3,
default.) **Aisha (dossier row 26, seen):** "take the offer, I'm the
cost" — in her words; the wound holds (she asks for nothing).
**Boyd:** the July line in the AD's mouth; the stakes. **Whit:** named;
his daughter. **Odell:** the anchor. **Tick:** the air, flat.
**Verna:** one look at most.
...
In his terms: four days to the hearing (Monday the first), six to the
findings (Wednesday the third), nine to her answer (Saturday the
sixth); the extension on the trustees' February agenda; the lawyer's
rule that anything he says makes it worse for her; the one thing that
would fix it costs him the job.

## COUPLE LINE

At the door, in their words: her exit (keep the season; she was
leaving anyway) and his (he will take the cost). Neither accepts. NOT
"stay" — BANNED (29's).

## END REGISTER: BUTTON (dark), on the turn signal. 25 ended down at Verna's step; 24 down at her office door; 23 down on two phones.

Not a storm door, not a car loaded, not alone under a light, not a
phone. The signal ticking in the dark cab, the wheel turned away from
home. A button is a last line that lands and stops — dark, not wry.

## ROOTING FOR

**Dan:** Whit's ankle taped and his girl remembered — seen by nobody;
the extension weighed and given up — seen by nobody until 27.
**Aisha:** she stops him from spending the sentence on her — seen by
him.

## NAMING, FULL LIST

Narration (his POV): "Dan" is not used for himself in narration beyond
the POV's habit (ch 24's practice); "Doc" to her face (his sole use);
"Aisha" in his head. "Whit" once somebody says it; "Carl Whitlow"
once at most. "the athletic director" — never "the AD" on the page.
"the lawyer" (unnamed); "the reviewer" (`[TK]`). "Tick", "Delmar",
"Ray" at the Table; "Odell" with who he is (a barber). "Verna". "Rex
Boyd" NEVER on this page. "Trey" in his head; "7" in the Table's and
the shop's mouths.

## FURNITURE, CITED

The window and "Film's at four" (ch 24; registry 231); the parka's
twin on his hook (ch 18; B2-T02 saved); "her protocol" on the
fourteenth (ch 22); the Coach's Table (registry 41–45); Odell's shop
and his anchors (ch 8, 18; registry 154); the rehab rooms and the
whirlpool (ch 19, 23, 25); the annex lawn and the flags (ch 23); the
Magnolia Court, room nine, Verna's gravel, the loaded RAV4 with the
parka on the top box (ch 25); his truck; his house, a brick house with
a carport (registry 145) — "home" for the turn signal.

## BANS AND BUDGETS

- Sentences END (STYLE (a)): ordinarily under thirty; at most three
  "and"s. THE TAIL (H001): one or two sentences run past forty.
- The half he means, in any wording (MAIN MOVED 1) — 27's.
...
- Calendar: "Monday the twenty-fifth" and "Thursday the twenty-eighth"
  ...
  NEVER "two weeks".
- The clock between scenes on the page (L053): how he gets from the
  AD's office to the rehab rooms to Odell's to Delmar's porch to the
  Court; why she is at her door; how long the Table runs.
- Names, not "he," where two men share a paragraph (L045).
- BANNED: RECENT.md as of today; studio/lessons/bans.txt; "in this
  room/car/office"; "somebody's"; "never once"; "one beat"; "plainly"
  more than once; "electricity"; "the AD"; Ty for the trainer; the
  weekday-and-date sentence as its own first-paragraph line; every
  thank-you shape (L042); a face that "did nothing" (L050); the empty
  chair or stool; the office door as the ending (24); alone under a
  light; "said, to the <object>"; heart-then-stomach; "in daylight";
  "was the paper".
...
23 (fair on both sides — the reviewer's question is fair; the AD's
July line is a real argument); 20 (the touch has a body — the kiss,
four or more body sentences); 15 (rooted for: the reader must still
want him after the Table); 16 (slow down at the door); 1 (every clock
a date; the step back said); 21 (who Whit is, who Odell is); 22 (the
stakes blatant, once each); 6 (not a sixth date-line opening; not a
fourth solo ending); 3 (the wound — his — in his body); 13 (the card).

## THE CARD'S CALLS — RULED at default (the author's go, 2026-09-24)
