...
Romance 6 · Heat 3 · Aisha 3 · Dan 1 · Wound 3 · Fun 1 · Town 3 ·
Menace 1 · Ends down · Talk quiet · Words 3400 · Pays Aisha.
On the AUTHOR'S scale (TARGETS definitions): Romance 6 with the leads
apart is the plan's stretch — it needs CONFLICT between them on the
page, not longing; the conflict here is hers with him in absence, and
the page must make it between them: the phone in her hand twice, the
sentence he did not say at the window packed around, and (call 1) the
call she makes or does not. If call 1 is NO (the default), the honest
number on the author's scale is 4–5 and the page should not pretend
otherwise; the PR says so. Heat 3 counts only in a shared room — with
no shared room this chapter, heat is 1 on the author's scale (the coat
on the box is memory); the plan's 3 was set before the author's
definitions and the PR says that too. Aisha 3: TURNED — she chooses
to leave (the identity's answer; the person at the end decides
differently than at the start). Dan 1: seen — the slice set down at
...
the man who wants her ground, said once, plain. Talk QUIET (8–15%).
Ends DOWN on an image (the folded coat). Pays Aisha. Words 3400;
3600 the ceiling.
...
is named once. Dan, offstage, loses the chance to be asked.
...
| Dan (absent) | a second time ends him (D30.1) | a hint at most, in the why she does not call |
