# Campus Book 1.2 — State of Play

**Created at kickoff (2026-08-29, author "Go 1.2"). Thread
handoff file for Book 1.2; read FIRST, then studio/VISION.md
(the series gradient + 1.2 voice blocks), ../DIALS.md,
book2/DECISIONS.md, ../energy-bank.md (the estate-sale shelf),
studio/RETRO-BOOK1.md (the ratified operating rules — ALL
production runs under them: brief audit, label shuffle,
...
studio/PIPELINE.md, the audio gate). Listening file is in chat;
comments from the listen = rulings. Do not treat the wait as a
stall.** Full conveyor ran
...
board"); the county's official wrong story (callback canon);
T23 sheets; the Kudzu wire (1.3's proof); the unnamed engineer;
the House wintering under tarps, crew contracted through March;
Kat selling Marisol's old house "to somebody with kids."
