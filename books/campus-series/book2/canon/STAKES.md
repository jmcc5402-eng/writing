# Stakes — what every named character stands to lose (B2-D27)

The author (2026-09-20): "in the moment when that character is on the
scene, the reader always knows that the stakes are high for that
character" — mostly self-inflicted, never owed a resolution, and some
of them dark. This sheet is the plan; the brief's STAKES ON THE PAGE
section names which of these the chapter carries and in whose line;
the brief gate refuses a chapter brief without that section from ch
22; the panel's STANCE test asks, for each named character on the
page, what the reader now knows they stand to lose.

Rules for the page: a stake is dropped in a line or two when the
person is in the room, in the POV lead's read or in what the town
knows — never a speech, never explained twice. A vice is never shown
being done unless the author says; it is smelled, counted, missed,
paid for. Nothing here resolves unless the outline says so.
...
| Aisha (the finding, #197) | **The finding decides the offer too (the author, 2026-09-25, AUTHOR-NOTES 295: "To raise the steaks, let's add one line insinuating that if the ruling is against Ayesha, she'll also lose the job at West").** A finding against her goes on her record, and in her own read the offer out west does not outlast it — both jobs on one Wednesday. Insinuated in her head, never confirmed by the western chair on a page. | No | ch 27 l.25–28, once ("The offer out west was made to a doctor with a clean one. / She doubted it would outlast a finding against her."); 28: the finding clears her, so the offer stands and the send is possible | Resolves ch 28 (cleared) |
...
| Who | Now | The turn |
|---|---|---|
| Boyd | Distrust him. His money wants her rooms and her job (B2-D13); he smiles and never threatens; he is the weather | None in this book (boyd-arc §4: he exits smiling) |
| Denny | The father who wants the doctor gone and blames her for the boy's fall; Dan does not like him and is kind to him anyway | Ch 28: he refused to sign the January letter (RH2) — the reader is not told before |
| Missy | Wants him on the field; Birmingham was ammunition; deciding whether the doctor is the enemy; drinks | Ch 28: the proof in her purse |
| The trainer | Ten thousand on a gambling habit; the man between the doctor and the coach | Not owed |

## Proposed (the showrunner's ideas, 2026-09-20 — none canon until picked)
...
| The athletic director | His job is Boyd's pledge | No |
| The consultant | Paid only if she goes | Yes |
| Verna Poteat | Her winter is one doctor; the survey chalk on Millrow runs through her gravel | No |
| Sonny Dillard | The new pumper is on the same February agenda as the pledge | No |
| Peanut | The Mule is on the square the money wants | No |
