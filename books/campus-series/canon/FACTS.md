...
| F-DAN-02 | Caught in season, both fired | A coach and the team physician in a relationship during the season are BOTH out the day it is proven — his second time ends him in college coaching; hers ends her here (B2-D30.1, LOCKED 2026-09-21; said blatantly on the page, ch 23 fold, then a hint per apart chapter) (L064) | B2-D30 | 1.2 | `\b(sat (him|her) down|a warning|a reprimand|suspended for)\b[^.]{0,40}\b(if they were caught|if the county found out|caught together)\b` |
