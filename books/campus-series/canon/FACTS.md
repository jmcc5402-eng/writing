...
| F-TRN-01 | The trainer's debt | **Ten thousand dollars**, a gambling habit; the amount never drifts (B2-D27.1, LOCKED 2026-09-20; canon/STAKES.md). It was his daughter's tuition (a sophomore at Ashford), bet trying to double it (B2-D32, 2026-09-24); the trainer is Carl Whitlow, "Whit" | B2-D27, B2-D32 | 1.2 | `\b(five|six|seven|eight|nine|twelve|fifteen|twenty|thirty|forty|fifty) (thousand|grand)\b[^.]{0,40}\b(bookie|owed|owes|debt|gambl|bet)` |
...
| F-DAN-03 | Dan's contract after the struck extension (the author, 2026-09-25, AUTHOR-NOTES 300) | His current contract runs through NEXT season; the trustees write the next one — with the extension struck (ch 27), he coaches one more season as a lame duck, and nothing after it is promised | the ch 28 fold; for the ch 29 brief (the price of the ask) | 1.2 | `\b(fired|contract (ends|runs out) (this|in) (June|spring))\b` |
| F-AGD-01 | The February agenda | Holds THREE things: Boyd's pledge (the performance center on the annex's ground), Dan's extension ("a review" after the loss), and the provider partner's contract that takes over team physician services — her job (B2-D13, D15, D28.4; L049); no vote date on any page; AS OF FEB 1 (1.2 ch 27): the pledge "re-sequenced to a later sitting" and the extension struck on the reposted agenda — the partner contract's fate is 29's (D33.6) | 1.2 ch20:143; DECISIONS | 1.2 | `\b(spring|March|April) agenda\b` |
