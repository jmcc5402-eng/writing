...
outlines will be gated against. Nothing here is canon until ratified;
every invention below §7's locked line is tagged PROPOSAL or [TK].

## Scope and terminology (read first)

The bible collides on the word "book." §6's "Books 1–4" are the ACTS
of Volume 1 — the origin novel now being finished — and the archive
file `manuscript/drafts/book4-draft1.md` is Act-4 material of that
novel (Grace's captivity, the proposal reveal), not a fourth book.
The bible's own [TK] asks to rename §6's movements to Acts. This
sketch therefore covers §12's VOLUMES 2–4, the author's own
four-volume series shape (brainstorm, 2026-07-28), and calls them
Books 2–4 as the series will. The fragment is honored here as
evidence of Volume 1's endpoint and of Donald's voice — the
"unending piece of his soul missing" line is Book 4's engine.

What Book 1 hands this sketch (from THREADS.md and the bible): Nick
warped north, "no idea where he was"; Grace rescued, half-believing
("Maybe it was a dream"); the town never learning its benefactor
("Nick who?"); Grace and Jim funded for San Francisco; the typhoid
doctor dream (T11) properly unpaid; Grace's remarkable memory (T12)
planted with no payer; Donald swept away, death unconfirmed; the
Grin-survives-sees-Nick-fly scene drafted since 2014. Where the
sketch depends on an open TODO decision — the Book 1 ending shape
above all — it sketches both branches in one line each.

Variance card A3 (sensory inventory) is applied as the per-book
sensory blocks. It conflicts with nothing in canon or format. No
banned moves are listed for plot-architect in
`studio/agents/variance/RECENT.md` this run.

## The series spine (Hauge, quarter-turns)

Per §12 and `studio/craft/hauge.md`: four volumes means the inner
journey moves in quarter-turns, one real stage per book. Outer
journeys run the full five-point spec inside each book.

| Book | Stage (§12) | Identity Nick starts in | Essence step earned |
|---|---|---|---|
| 1 | Origin | "I am my father's weakness" | He can act, unseen |
| 2 | Purpose | "The sleigh was an accident" | The work is his to do |
| 3 | Love | "The secret is mine alone" | A secret carried by two |
| 4 | Essence tested | "I must stay hidden to win" | Restraint IS strength |

The wound stays the father's (T09, still owed on Volume 1's page and
assumed paid in its rebuilt climax); Books 2–4 keep it warm without
re-litigating it, until Book 4 hands it to its original author,
Donald, for the final test.

PROPOSAL — mythos assignment across the volumes (the bible assigns
none beyond Volume 1, so this is proposed, not found): Book 2 locks
THE WORKSHOP; Book 3 locks THE LIST; Book 4 locks THE NIGHT and THE
SUIT. Grains planted along the way: the letters and the harness bell
in Book 3, the full team of eight in Book 4 (closing S02's series
debt). The wink discipline (SC1, §7.2) holds for all three books —
"Santa," "Christmas," and "North Pole" appear nowhere; every element
arrives as plot necessity, in an Alaskan's vocabulary.

---

# BOOK 2 — working label "The Far Station" [TK title]
...
CLOCK — the survival ledger scratched on the sleigh rail: days of
caribou feed against days of remaining sun, updated on the page,
public by chapter two. DENSITY — **MEDIUM**, declared per the
story-engine dial: the author's own §12 line calls Book 2 "a
standard adventure," the survival problem explains itself scene by
scene, and the freed pages go to the far-north setting, the craft,
and Grace's B-story.

## Series ledger line

INHERITS — the warp landing and "no idea where he was" (S06);
Grace's half-knowledge and the ending-shape branch; Donald
unconfirmed-dead. PLANTS for Book 3 — the station as Nick's base
and store; Grace credentialed in San Francisco; Donald alive in the
reader's superior position; contact with the wild caribou herds
(the future team); the tally-wall keeper question. LOCKS — THE
WORKSHOP, earned as repair-shop necessity, never named for what the
reader knows it is; the unnamed far place itself (the page never
names it — see open question 8).

## Sensory inventory (card A3)

- Cold so deep it has no smell at all — until the station door, and
  then cedar shavings, tallow, and old lamp oil, forty years asleep.
- Light: six shades of blue on white, the sleigh's red glow the only
  warm color in the world; later, aurora moving like water overhead.
- Sound: silence that lets him hear his own pulse; the dry click of
  caribou tendons on the march; wind against the ridge like a plane
  on end-grain.
- Touch: the stone's faint warmth through a mitt when it is set
  right, and its dead-rock cold when it is not — the magic's whole
  sensory signature this book, withheld and then returned.
- Taste: pilot bread, rendered fat, snow-melt with iron in it.

## Structure guards

Withheld payoff (SC2 discipline at series scale): no whole flight
until Q4. SUPERCONCEPTS — SC1: workshop and station hidden inside
repair necessity; SC3: the book IS the craft; SC4: every magical
beat priced in feed, wood, and daylight. Location roster below.

LOCATION ROSTER — recurring (3): **the Far Station** [TK name —
proposal: never named on the page], one-line identity "a dead man's
workshop under the ice, still warm somehow," reached only by warp
or long flight north of everything; **the ice shelf and lichen
flats**, "the larder that is always almost empty," the station's
doorstep; **Bronston**, "the town that owes its luck to no one it
can name," far south, Grace's quarter of the book. Single-visit,
named but uncounted: the calved shelf edge, the beached escape
boat, the rock at the creek.

---

# BOOK 3 — working label "The Fever Winter" [TK title]
...
CLOCK — Grace's chalkboard in the meeting hall: every name, every
fever-day, growing daily in public, against the fixed fact that the
pass opens in six weeks [TK count] and the sick do not have six
weeks. DENSITY — **DEEP**, declared: the epidemic carries its own
body of intrinsic detail (waterborne tracing, the memory-map,
frontier nursing and engineering) that funds a true explanation
movement in the climax, and this is the series' inner-journey heart
— the one book that should spend that budget.

## Series ledger line

INHERITS — the station and stores (B2); Donald alive in superior
position; T11 (typhoid dream) and T12 (the memory) from Book 1,
both paid here; T19's heart at the rock, paid. PLANTS for Book 4 —
Donald has wintered close and is counting (stake, tally); the
witness legend of the thing that flies; Grace as co-keeper; the
betrothal; the bell and the letters grains. LOCKS — THE LIST,
origin: Grace's remarkable memory made public practice, checked
against the chalkboard — checked twice — and read by Nick each
night to know which doorstep needs what.

## Sensory inventory (card A3)

- Sickroom: carbolic and vinegar, wet wool steaming by the stove,
  tallow-light on chalk dust.
- The town under inversion: woodsmoke lying flat at roof height,
  and Nick flying just above it, runners hissing through the smoke
  layer.
- Sound: the hush a sleigh makes where dogs would bark — and then
  one small bell, meaning one thing to one person.
- The magic's signature grown domestic: stone-warmth now steady as
  a banked coal; the red glow dimmed under canvas so it cannot be
  seen from below.
- Cold water: the seep's mineral reek inside the workings, rope
  going stiff, hands past feeling — SC4 pricing the climax.

## Structure guards

Withheld payoff: Grace never shares the sky until Q4. SUPERCONCEPTS
— SC1: list, letters, bell all hidden in plague logistics; SC3:
Grace's memory and Nick's rigging solve it, shown; SC4: the tensest
scenes survive with the magic removed entirely. Fair-play: the
water source is guessable from Q1 (spring below the workings on the
page early, blame pointed elsewhere — the barred-doors panic is the
red herring).

LOCATION ROSTER — recurring (3): **Bronston meeting hall and town**,
"a town nursing itself in public, in chalk"; **the spring and the
drowned Grin workings** above it, "the old crime, still leaking";
**the mountain cave**, "Nick's relay between two worlds," between
town and the far station. Single-visit: the rock at the creek (the
proposal), the pass summit, the last boat's dock.

---

# BOOK 4 — working label "The Longest Night" [TK title]
...
CLOCK — the claim notice nailed to the assay office door, its
contest deadline printed and dated: the window closes at midwinter,
N days [TK count], read aloud on the page in chapter one and
counted down in public thereafter. DENSITY — **MEDIUM**, declared:
the villain plot is procedural and moral, not technical — a claim,
a lie, a testimony — and explains itself scene by scene; the freed
pages go to the two journeys converging and the series' payoffs
(the team, the suit, the night, the wound). Series mix: MEDIUM /
DEEP / MEDIUM — no two DEEPs adjacent, per the dial rule.

## Series ledger line

INHERITS — everything: Donald's knowledge (B2 hint, B3 stake), the
witness legend and the two-keeper secret (B3), the station (B2),
the father wound (B1, T09) and Duff/James's unresolved fates (T14,
T15). PAYS — the wound to its author; the "Nick who?" thesis at
series scale; S02 in full (the team of eight). LOCKS — THE NIGHT
(the one great midwinter flight that becomes annual — the series'
last line can promise "next year" without saying which night it
is) and THE SUIT (Grace's making: red trade-wool because red is
the cheap bolt left in a poor town, hooded and fur-trimmed because
midwinter flight demands it — warmth first, legend by accident).

## Sensory inventory (card A3)

- Midwinter dark at noon: lamplight in windows at midday, breath
  freezing in beards, the assay office notice crackling with frost.
- Paper and men: gun oil, ink, wet serge — the syndicate smells
  like an office walking through a frontier town.
- The suit before it is a legend: dye-vat and lanolin, new wool
  still smelling of the kettle, fur ruff beading with breath-ice.
- Sound of the climax: storm-wind at the cliff scouring words away
  — the same voice-eating wind as Book 1's push — then, after, the
  soft total silence of the great flight, cut only by one bell.
- The magic full-grown: stone-warmth Nick no longer notices, glow
  banked to embers under canvas — by the last book the wonder is
  ordinary to him and brand-new to the reader flying with Grace.

## Structure guards

Withheld payoff: the full team of eight never flies whole until the
longest night. SUPERCONCEPTS — SC1: night, suit, team, all costumed
as necessity; SC2's mirror at series scale (pushed off a cliff in
Book 1 chapter 1, catching his murderer at the same cliff at series
end); SC3: testimony, memory, and knots beat the syndicate — no
aftershock luck this time, by design; SC4: the storm and the paper
would carry the climax with the sleigh deleted. Hard guard: decision
7 stays law — the belt appears only as keepsake and unlocks
nothing; nothing in the finale may make the magic hereditary.

LOCATION ROSTER — recurring (3, and deliberately the series' whole
map converging): **Bronston (assay office and meeting hall)**, "the
town that must decide what it believes"; **the mountain cave and
cliff**, "where the war started and must end"; **the far station**,
"the refuge that becomes the home." Single-visit: the steamer
anchorage, the recorder's office at the port [TK port — Lola per
ch13, CHECK against bible §4 housekeeping].

---

# Series structure check

Plants and payoffs across the three books (fair-play at series
scale; each row must survive rung-2 chapter placement):

| Plant | Planted | Pays |
|---|---|---|
| Donald survives, saw Nick fly | B2 Q2 (reader only) | B4 Q1 claim-as-trap; B4 Q4 |
| The tally-wall keeper | B2 Q1 | B3 station stores; B4 Q3 wound beat; series [TK — see OQ1] |
| Station tools/stores | B2 Q1–Q2 | B3 night supply; B4 refuge |
| Grace's memory (T12, from B1) | B1 ch3 | B3 Q3 memory-map; B4 Q4 recitation |
| Typhoid dream (T11, from B1) | B1 ch3 | B3 whole spine |
| Rock heart (T19, from B1) | B1 | B2 letter branch; B3 proposal |
| Wintered-close evidence | B3 Q4 | B4 Q1 return |
| Witness legend of the flier | B3 Q3 | B4 Q3 inversion (the backfire) |
| Harness bell | B3 Q1 | B3 Q2 catch; B4 final flight |
| Children's notes (letters) | B3 Q1 | B4 the night's route |
| Caribou herd contact | B2 Q4 | B4 Q2 team of eight |
| Duff's defection (B1) | B1 ch20 | B4 Q3–Q4 testimony |
| James talks too much (B1 trait) | B1 | B4 Q4 — finally load-bearing FOR the town |
| Red-wool coat | B4 Q1 (making) | B4 Q4 (the suit) |

Dangling by design (series-final page): who kept the far station
(unless OQ1 resolves it inside B2/B4); "next year," the annual
night. Nothing else may dangle at series end.

Stakes escalation: B2 risks Nick's life; B3 risks the town's lives
and the secret; B4 risks the meaning of everything already given —
the record itself. Red herrings: B2, the stone read as broken when
it is mis-set; B3, the barred-doors contagion panic pointing at the
gifts instead of the water; B4, the "night thief" case, built from
true sightings wrongly assembled.

Register and rules carried: older all-ages (decision 8); wink
discipline (decision 2) — three books, zero uses of the words the
reader is thinking; survival-adventure first, per SUPERCONCEPTS —
every book's climax survives with the magic deleted (SC4's test
applied at book scale).

# Open questions (all PROPOSAL-tagged; nothing decided silently)

1. **The keeper of the far station / the father.** The 2013 sheet's
   "Is he currently Santa?" and T24's Gus Anderson dashed-dream are
   the same fork, and the bible says rule on it before Volume 2.
   PROPOSAL: the keeper is a stranger, long dead; the father knew OF
   the work (the dashed shared dream = he and Jim once sought the
   station and failed), which keeps decision 7 intact — recognition,
   never inheritance, and sainthood stays earned (SC3). Branch B: the
   father reached it — then B4 Q3's belt beat becomes a reveal, and
   the sketch holds either way at one line's cost.
2. **Book 1 ending shape (vanish vs confession)** — the TODO's open
   ★ decision. Both branches are sketched at B2 Q1 and B4 Q4; the
   sketch does not need it decided to gate rung 2 of Book 2, but
   drafting B2's Grace chapters does.
3. **Donald survives (the 4.8 "(( Other draft ))" variant).** §12
   already leans on it and Book 4 requires it. PROPOSAL: adopt it as
   the Book 1 climax variant and record it in §7. If the author
   instead kills Donald, Book 4's antagonist becomes James-plus-
   syndicate and this sketch's B4 needs a new Q3–Q4 — flag early.
4. **Book 3's twist ([TK] in §12).** PROPOSAL: the outbreak flows
   from the Grins' quake-flooded workings — the old crime poisoning
   the town, linking B2's hint to B4's fuse with Donald off-page.
   Alternates: (a) Grace must choose between her San Francisco
   examinations and the quarantine; (b) a mid-epidemic Donald
   sighting. These can stack; (a) works as her B-story cost.
5. **Mythos assignment split** (workshop / list / night+suit, with
   letters and bells as B3 grains). PROPOSAL as tabled above; the
   bible assigns none of it, so this is the sketch's biggest single
   invention and should be ratified or reshuffled as a set.
6. **Wedding placement.** PROPOSAL: proposal ends B3, wedding opens
   B4 (gives Donald a life to threaten, and B4's clock starts on a
   high). Alternate: wedding closes B3, B4 opens a year on.
7. **Grace's training timeline.** PROPOSAL: she goes to San
   Francisco in B2, returns partially credentialed in B3 — the
   doctor dream is paid in action, not diploma; whether she ever
   formally finishes is a B4 aftermath line.
8. **Naming the far place.** PROPOSAL: never named on the page in
   any book — "the station" in our docs only — extending the wink
   discipline; the last thing the series should print is a map.
9. **The eight caribou's names.** B4 gives the team; whether they
   get on-page names (plain frontier names, or near-miss winks at
   the traditional eight) is pure author voice. PROPOSAL: plain
   working names or none; a wink here is the one place the disguise
   could tear.
10. **Four-volume cap.** §12's max-four supersedes the 2025 40-book
    note per its own [TK: confirm]. This sketch assumes four; if the
    author reopens more volumes, B4's "for good" ending softens to
    "for now."

*Style sweep run: no paragraph in this file ends in a colon or a
dash. Sources: STORY_BIBLE.md §§1–12, SUPERCONCEPTS.md, THREADS.md,
TODO.md, book4-draft1.md (as Volume 1 Act-4 evidence),
studio/DRAFTING-PROTOCOL.md, studio/craft/hauge.md, and the
Spytwins story-engine density dial (author, 2026-08-04).*
